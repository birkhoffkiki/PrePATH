...
wsi_dir="/NAS2/Data4/llb/协和医院结直肠癌数据/slides"  # The directory where the WSI files are stored
slide_ext=.ndpi  # The extension of the WSI files, remeber to keep the `.` in front
feat_dir="/NAS2/Data1/lbliao/Data/CRC/协和/feat-1" #path to save feature
...
GPU_LIST="0 3 4 6" # GPU IDs you want to use, separated by space
